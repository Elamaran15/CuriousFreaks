...
public class PalindromeLL {
    ...
    static boolean isPalindrome(Node head) {
        Node reveseNode=reverseList2(head);
        while(reveseNode!=null && head!=null){
            if(reveseNode.data!=head.data)
                return false;
    ...
    public static boolean isPalindromeA2Z(Node head) {
        ...
        Node newHead = reverseList2(slow.next);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(isPalindromeA2Z(head));
    }
